...
def add_app_to_wallet(name=str, app=str, username=str, password=str) -> None:
    """
...
def del_app_from_wallet(name=str, app=str) -> int:
    """
...
def edit_credentials(name=str, app=str, new_app_name=str, new_username=str, new_password=str) -> int:
    """
    Function that allows the user to edit existing credentials stored in his wallet.\n
    ...
    if index_app != -1:
        credentials = file_data[f"Wallet of {name}"][index_app]

        credentials["application"] = new_app_name
